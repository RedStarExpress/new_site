                ...
                <div class="row g-5">
                    <div class="col-lg-3 col-md-6">
                        ...
                        <div class="d-flex pt-2">
                            <a class="btn btn-square me-1" href="#1"
                            ...
                            ></a>
                            <a class="btn btn-square me-0" href="#1"
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <p><i class="fa fa-phone-alt me-3"></i>+998 33 190 26 660</p>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            &copy; <a href="#1">Your Site Name</a>, All Right Reserved.
                        </div>
